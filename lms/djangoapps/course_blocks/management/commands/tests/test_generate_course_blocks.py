...
from ....tests.helpers import is_course_in_block_structure_cache, EnableBlockTransformerCacheMixin


class TestGenerateCourseBlocks(EnableBlockTransformerCacheMixin, ModuleStoreTestCase):
    """
